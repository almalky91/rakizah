    ...
    <div className="min-h-screen bg-background">
      ...
      {profile.phone_number && (
        <a
          ...
          className="fixed bottom-6 left-6 z-50 w-14 h-14 bg-[#25D366] hover:bg-[#1ebe57] text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
